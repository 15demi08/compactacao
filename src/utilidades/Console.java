...
public final class Console {
    ...
    /**
     * Print the string representations of all arguments to the standard output.
     *
    ...
    /**
     * Prompts for a line of text from the standard input and returns it as a
     * single string.
     *
    ...
    /**
     * Reads a line of text from the standard input and returns it as a single
     * string.
     *
     * @return The text from the line read as input.
     */
    ...
    /**
     * Prompts for a string from the standard input and returns it. The string
     * returned will be limited by any of TAB, space, new line or carriage
     * return characters.
     *
    ...
    /**
     * Reads a string from the standard input and returns it. The string
     * returned will be limited by any of TAB, space, new line or carriage
     * return characters.
     *
     * @return The string read as input.
