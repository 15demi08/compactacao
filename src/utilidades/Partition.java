...
import estruturas.FunctionObjects;
...
public class Partition {
    ...
    /**
     * Given a pivot, partitions data in less than the pivot and greater than
     * the pivot. The data type used must be able to compare against itself. If
     * there's a value that is equal to the given pivot, if the whole data is
     * sorted, that value would already be on its final position. Returns the
     * index where the list was partitioned.
     *
    ...
    /**
     * Given a pivot, partitions data with respect to the comparator given. If
     * there's a value that is equal to the given pivot, if the whole data is
     * sorted, using the same comparator, that value would already be on its
     * final position. Returns the index where the list was partitioned.
     *
     * @param values The data set.
     * @param pivot The value used as comparator.
    ...
    /**
     * Given a pivot, partitions a portion of the given data, starting at index
     * 's' end ending at index 'e' (both included), with respect to the
     * comparator given. If there's a value that is equal to the given pivot, if
     * the whole data is sorted, using the same comparator, that value would
     * already be on its final position. Returns the index where the list was
     * partitioned.
     *
     * @param values The data set.
    ...
    /**
     * Partially sort the given data, so that the n<sup>th</sup> element is in
     * its final position, if the whole data was sorted.
     *
     * @param values The data set.
    ...
    /**
     * Partially sort the given data, so that the n<sup>th</sup> element is in
     * its final position, if the whole data was sorted, with the given
     * comparator.
     *
     * @param values The data set.
     * @param n The position of the element.
